...
void smooth2(int dim, pixel *src, pixel *dst) 
{
    ...
    */
    ...
    for(int j = 0;j < dim; j++)
    {
        ...
        sum[0][j].red = (int)((int)src[j].red + (int)src[dim+j].red);
        sum[0][j].green = (int)((int)src[j].green + (int)src[dim+j].green);
        sum[0][j].blue = (int)((int)src[j].blue + (int)src[dim+j].blue);
        ...
        int m = (dim-1)*dim+j;
        int n = (dim-2)*dim+j;
        sum[dim-1][j].red = (int)((int)src[m].red + (int)src[n].red);
        sum[dim-1][j].green = (int)((int)src[m].green + (int)src[n].green);
        sum[dim-1][j].blue = (int)((int)src[m].blue + (int)src[n].blue);
    }
    ...
    for(int i = 1; i < dim-1; i++)
    {
        for(int j = 0; j < dim; j++)
        {
            ...
            int y = i*dim + j;
            int z = (i+1)*dim + j;
            sum[i][j].red = (int)((int)src[x].red + (int)src[y].red + (int)src[z].red);
            sum[i][j].green = (int)((int)src[x].green + (int)src[y].green + (int)src[z].green);
            sum[i][j].blue = (int)((int)src[x].blue + (int)src[y].blue + (int)src[z].blue);
        }
    }
